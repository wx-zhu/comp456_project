...
# Create the bar plot
add <- ggplot(df_kid_mental, aes(x = K2Q31C, y = ACE_score, fill = K2Q31C)) +
  geom_boxplot() +
...
dep <- ggplot(df_kid_mental, aes(x = K2Q32C, y = ACE_score, fill = K2Q32C)) +
  geom_boxplot() +
...
anx <- ggplot(df_kid_mental, aes(x = K2Q33C, y = ACE_score, fill = K2Q33C)) +
  geom_boxplot() +
