...
df <- read_csv("~/Desktop/comp 456/topical_data_cleaned.csv")
...
```{r}
data2021 <- read_sas('~/Desktop/comp 456/nsch_2021_topical.sas7bdat')
data2020 <- read_sas('~/Desktop/comp 456/nsch_2020_topical.sas7bdat')
data2019 <- read_sas('~/Desktop/comp 456/nsch_2019_topical.sas7bdat')
data2018 <- read_sas('~/Desktop/comp 456/nsch_2018_topical.sas7bdat')
```
